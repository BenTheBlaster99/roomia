...
export interface CatalogItem {
  ...
  available: boolean
  notes?: string
  /** Primary material when known (filterable in Studio catalog). */
...
export const MOCK_CATALOG: CatalogItem[] = [
  ...
  // LIGHTS
  { id: 'c-019', name: 'Accent', category: 'Light', room: ['Living Room', 'Bedroom'], style: 'Industrial', price: 35000, color: '#1F2937', modelUrl: null, imageKeyword: 'black metal pendant light', available: true },
  ...
  { id: 'c-026', name: 'Gilded', category: 'Coffee Table', room: ['Living Room'], style: 'Maximalism', price: 55000, color: '#D4A017', modelUrl: null, imageKeyword: 'gold glass coffee table', available: true },
  { id: 'c-027', name: 'Chandelier', category: 'Light', room: ['Living Room'], style: 'Maximalism', price: 85000, color: '#FFD700', modelUrl: null, imageKeyword: 'crystal chandelier', available: true },
  ...
  { id: 'c-030', name: 'Zellige', category: 'Coffee Table', room: ['Living Room'], style: 'Traditional Algerian', price: 35000, color: '#1F4E79', modelUrl: null, imageKeyword: 'mosaic tile table', available: true },
  { id: 'c-031', name: 'Atlas', category: 'Dining Table', room: ['Living Room'], style: 'Traditional Algerian', price: 95000, color: '#5C3D1E', modelUrl: null, imageKeyword: 'carved wood dining table', available: true },
  ...
  { id: 'c-035', name: 'Harbor', category: 'Light', room: ['Living Room'], style: 'Mediterranean Coastal', price: 28000, color: '#FFFFFF', modelUrl: null, imageKeyword: 'white pendant light', available: true },
  ...
  { id: 'c-040', name: 'Zen', category: 'Light', room: ['Living Room'], style: 'Minimalism', price: 22000, color: '#FFFFFF', modelUrl: null, imageKeyword: 'minimal white pendant', available: true },
  ...
  { id: 'c-045', name: 'Opulent', category: 'Light', room: ['Bedroom'], style: 'Maximalism', price: 65000, color: '#FFD700', modelUrl: null, imageKeyword: 'crystal bedside lamp', available: true },
  ...
  { id: 'c-054', name: 'Seafoam', category: 'Light', room: ['Bedroom'], style: 'Mediterranean Coastal', price: 24000, color: '#4F84A6', modelUrl: null, imageKeyword: 'blue glass lamp', available: true },
  ...
  { id: 'c-056', name: 'Reed', category: 'Chair', room: ['Bedroom'], style: 'Mediterranean Coastal', price: 30000, color: '#F5F5F0', modelUrl: null, imageKeyword: 'wicker bedroom chair', available: false },
  ...
  { id: 'c-059', name: 'Glow', category: 'Light', room: ['Bedroom'], style: 'Minimalism', price: 20000, color: '#FFFFFF', modelUrl: null, imageKeyword: 'minimal bedside lamp', available: true },
  { id: 'c-060', name: 'Pebble', category: 'Chair', room: ['Bedroom'], style: 'Minimalism', price: 42000, color: '#E5DDD0', modelUrl: null, imageKeyword: 'minimal bedroom chair', available: false },
]
